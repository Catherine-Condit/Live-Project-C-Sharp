...
&emsp;For the final two weeks of The Tech Academy program, I participated in the C# Live Project where I worked with a team of developers to contribute to a real-world web application called TheatreCMS3. This application serves as a comprehensive management system for a theater’s website, with features that cover rentals, events, performances, and user interactions.
...
1. RentalHistory Model and CRUD Functionality
2. RentalHistory CRUD Part #1: Create & Edit Pages
3. RentalHistory CRUD Part #2: Index Page
4. RentalHistory CRUD Part #3: Sorting
5. RentalItem Entity Model & CRUD Functionality
6. RentalItem Photo Storage & Retrieval
7. RentalItem CRUD Pages Part 1: Create & Edit Pages Styling
8. RentalItem CRUD Pages Part 2: Index Page
9. RentalItem CRUD Pages Part 3: Details/Delete Simple Styling
10. RentalItem CRUD Pages Part 4: Index Page Search Feature
11. RentalItem Create Page Photo Display

### RentalHistory Model & CRUD Functionality
&emsp;My first major task on the project was to create the RentalHistory entity model and scaffold the corresponding CRUD pages to allow users to create, view, edit, and delete rental history records. I began by defining the model based on a provided schema and integrating it into the existing codebase under the Areas > Rental folder. To ensure database connectivity, I registered the new model with the existing ApplicationDbContext in IdentityModels.cs, then used Visual Studio's scaffolding tools to generate the controller and views for standard CRUD operations. All generated pages were configured to use the site-wide _Layout.cshtml file for a consistent UI. After scaffolding, I updated the database and verified that the new RentalHistories table had been correctly created using SQL Server Object Explorer. Once everything was in place, I tested each route to confirm that rental history records could be successfully added, viewed, edited, and deleted within the application.

### RentalHistory CRUD Create & Edit
...
### RentalHistory CRUD Part #2: Index Page
...
### RentalHistory CRUD Part #3: Sorting
...
### RentalItem Entity Model & CRUD Functionality
...
### RentalItem Photo Storage & Retrieval
...
### RentalItem CRUD Pages Part 1: Create & Edit Pages Styling
...
### RentalItem CRUD Pages Part 2: Index Page
...
### RentalItem CRUD Pages Part 3: Details/Delete Simple Styling
...
### RentalItem CRUD Pages Part 4: Index Page Search Feature
...
### RentalItem Create Page Photo Display
